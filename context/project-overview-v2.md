# Project Name: Gadded
- Headline: AI-Powered Solar Decision Support for Egyptian Factories
- Scope and Granularity: Egypt, governorates that have industrial sites and factories.
### We are creating the documentation for our PoC prototype.

# Context:

## Current Problem, in simple words: 

Many factories and small-to-medium enterprises (SMEs) in Egypt are interested in installing rooftop solar systems to reduce electricity costs and benefit from initiatives such as the Shams Al-Sinaa program. However, making the right investment is difficult. Most factory owners do not know what system size they need, how much money they will actually save, how long it will take to recover the investment, or whether paying in cash or financing the system is the better option.
As a result, many businesses either delay adopting renewable energy, purchase systems that are larger or smaller than they need, or rely entirely on sales representatives whose recommendations may not always be optimized for the factory's actual electricity usage.

## Overview

Gadded is a decision-support platform for Egyptian factories, SMEs, and renewable-energy developers. It turns basic project information, a location, and electricity-consumption data into a preliminary solar-project assessment covering:
...
10. The reader can understand which components are ML, physics, optimization, simulation, rules, and LLM orchestration.
